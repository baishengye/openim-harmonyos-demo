...
napi_value NAPI_createImageMessageByURL(napi_env env, napi_callback_info info) {
    ...
    napi_get_cb_info(env, info, &argc, args, nullptr, nullptr);
    std::string operationID = GetStringFromJS(env, args[0]);
    std::string sourcePath = GetStringFromJS(env, args[1]);
    std::string sourcePicture = GetStringFromJS(env, args[2]);
    std::string bigPicture = GetStringFromJS(env, args[3]);
    std::string snapshotPicture = GetStringFromJS(env, args[4]);
    if (operationID.empty()) {
    ...
    SdkString result(CreateImageMessageByURL(MutableCString(operationID), MutableCString(sourcePath),
                                             MutableCString(sourcePicture), MutableCString(bigPicture),
                                             MutableCString(snapshotPicture)));
    return CreateJSString(env, result.str());
}
...
napi_value NAPI_createSoundMessageFromFullPath(napi_env env, napi_callback_info info) {
    ...
    SdkString result(CreateSoundMessageFromFullPath((char*)operationID.c_str(), (char*)soundPath.c_str(), duration));
    return CreateJSString(env, result.str());
}
...
napi_value NAPI_createSoundMessageByURL(napi_env env, napi_callback_info info) {
    ...
    SdkString result(CreateSoundMessageByURL((char*)operationID.c_str(), (char*)params.c_str()));
    return CreateJSString(env, result.str());
}
...
napi_value NAPI_createFileMessageFromFullPath(napi_env env, napi_callback_info info) {
    ...
    SdkString result(CreateFileMessageFromFullPath((char*)operationID.c_str(), (char*)fileFullPath.c_str(), (char*)fileName.c_str()));
    return CreateJSString(env, result.str());
}
...
napi_value NAPI_createFileMessageByURL(napi_env env, napi_callback_info info) {
    ...
    SdkString result(CreateFileMessageByURL((char*)operationID.c_str(), (char*)params.c_str()));
    return CreateJSString(env, result.str());
}
...
napi_value NAPI_createVideoMessageByURL(napi_env env, napi_callback_info info) {
    ...
    SdkString result(CreateVideoMessageByURL((char*)operationID.c_str(), (char*)params.c_str()));
    return CreateJSString(env, result.str());
}
...
napi_value NAPI_createVideoMessageFromFullPath(napi_env env, napi_callback_info info) {
    ...
    SdkString result(CreateVideoMessageFromFullPath((char*)operationID.c_str(), (char*)videoFullPath.c_str(), (char*)videoType.c_str(), duration, (char*)snapshotFullPath.c_str()));
    return CreateJSString(env, result.str());
}
...
napi_value NAPI_createLocationMessage(napi_env env, napi_callback_info info) {
    ...
    double longitude = GetDoubleFromJS(env, args[2]);
    double latitude = GetDoubleFromJS(env, args[3]);
    if (operationID.empty()) {
    ...
    SdkString result(CreateLocationMessage((char*)operationID.c_str(), (char*)description.c_str(), longitude, latitude));
    return CreateJSString(env, result.str());
}
...
napi_value NAPI_createFaceMessage(napi_env env, napi_callback_info info) {
    ...
    SdkString result(CreateFaceMessage((char*)operationID.c_str(), index, (char*)data.c_str()));
    return CreateJSString(env, result.str());
}
...
napi_value NAPI_createCardMessage(napi_env env, napi_callback_info info) {
    ...
    SdkString result(CreateCardMessage((char*)operationID.c_str(), (char*)params.c_str()));
    return CreateJSString(env, result.str());
}
...
napi_value NAPI_createTextAtMessage(napi_env env, napi_callback_info info) {
    ...
    SdkString result(CreateTextAtMessage((char*)operationID.c_str(), (char*)text.c_str(), (char*)atUserIDList.c_str(), (char*)atUsersInfo.c_str(), (char*)quoteMessage.c_str()));
    return CreateJSString(env, result.str());
}
...
napi_value NAPI_sendMessage(napi_env env, napi_callback_info info) {
    ...
    std::string message = GetStringFromJS(env, args[2]);
    std::string recvID = GetStringFromJS(env, args[3]);
    std::string groupID = GetStringFromJS(env, args[4]);
    std::string offlinePushInfo = GetStringFromJS(env, args[5]);
...
napi_value NAPI_typingStatusUpdate(napi_env env, napi_callback_info info) {
    ...
    std::string msgTip = GetStringFromJS(env, args[3]);
    if (operationID.empty()) {
...
napi_value NAPI_markMessageAsRead(napi_env env, napi_callback_info info) {
    ...
    std::string operationID = GetStringFromJS(env, args[1]);
    std::string conversationID = GetStringFromJS(env, args[2]);
    std::string clientMsgID = GetStringFromJS(env, args[3]);
    if (operationID.empty()) {
...
napi_value NAPI_findMessageList(napi_env env, napi_callback_info info) {
    ...
    napi_get_cb_info(env, info, &argc, args, nullptr, nullptr);
    std::string operationID = GetStringFromJS(env, args[1]);
    std::string findOptions = GetStringFromJS(env, args[2]);
    if (operationID.empty()) {
...
napi_value NAPI_getAdvancedHistoryMessageList(napi_env env, napi_callback_info info) {
    ...
    napi_get_cb_info(env, info, &argc, args, nullptr, nullptr);
    std::string operationID = GetStringFromJS(env, args[1]);
    std::string getOptions = GetStringFromJS(env, args[2]);
    if (operationID.empty()) {
...
napi_value NAPI_setMessageLocalEx(napi_env env, napi_callback_info info) {
    ...
    std::string conversationID = GetStringFromJS(env, args[2]);
    std::string clientMsgID = GetStringFromJS(env, args[3]);
    std::string localEx = GetStringFromJS(env, args[4]);
    if (operationID.empty()) {
...
napi_value NAPI_markMessagesAsReadByMsgID(napi_env env, napi_callback_info info) {
    ...
    std::string operationID = GetStringFromJS(env, args[1]);
    std::string conversationID = GetStringFromJS(env, args[2]);
    std::string clientMsgIDs = GetStringFromJS(env, args[3]);
    if (operationID.empty()) {
...
napi_value NAPI_createAdvancedQuoteMessage(napi_env env, napi_callback_info info) {
    ...
    SdkString result(CreateAdvancedQuoteMessage((char*)operationID.c_str(), (char*)text.c_str(), (char*)message.c_str(), (char*)messageEntityList.c_str()));
    return CreateJSString(env, result.str());
}
...
napi_value NAPI_createAdvancedTextMessage(napi_env env, napi_callback_info info) {
    ...
    std::string operationID = GetStringFromJS(env, args[0]);
    std::string text = GetStringFromJS(env, args[1]);
    std::string messageEntityList = GetStringFromJS(env, args[2]);
    if (operationID.empty()) {
    ...
    SdkString result(CreateAdvancedTextMessage((char*)operationID.c_str(), (char*)text.c_str(), (char*)messageEntityList.c_str()));
    return CreateJSString(env, result.str());
}
