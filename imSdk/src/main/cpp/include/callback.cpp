...
int StoreBaseCallback(napi_env env, napi_value onSuccess, napi_value onError) {
    ...
    // Register with SDK
    RegisterBaseCallback(cbId, (int)CAPI_OnBaseSuccess, (int)CAPI_OnBaseError);
...
int StoreUploadCallbacks(
    ...
    RegisterUploadFileCallback(
        cbId,
        (int)CAPI_OnUploadOpen,
        (int)CAPI_OnUploadPartSize,
        (int)CAPI_OnUploadHashProgress,
        (int)CAPI_OnUploadHashComplete,
        (int)CAPI_OnUploadID,
        (int)CAPI_OnUploadPartComplete,
        (int)CAPI_OnUploadComplete,
        (int)CAPI_OnUploadFinish
    );
...
int StoreUploadLogCallback(napi_env env, napi_value onProgress) {
    ...
    // Register with SDK
    RegisterUploadLogProgress(cbId, (int)CAPI_OnUploadLogProgress);
...
int StoreSendMsgCallback(napi_env env, napi_value onSuccess, napi_value onError, napi_value onProgress) {
    ...
    // Register with SDK
    RegisterBaseCallback(cbId, (int)CAPI_OnBaseSuccess, (int)CAPI_OnBaseError);
    RegisterSendMsgCallback(cbId, (int)CAPI_OnSendMsg);
...
int StoreConnListener(
    ...
    RegisterConnListener(
        (int)CAPI_OnConnConnecting,
        (int)CAPI_OnConnConnectSuccess,
        (int)CAPI_OnConnConnectFailed,
        (int)CAPI_OnConnKickedOffline,
        (int)CAPI_OnConnUserTokenExpired,
        (int)CAPI_OnConnUserTokenInvalid
    );
...
int StoreMsgListener(
    ...
    RegisterMsgListener(
        (int)CAPI_OnRecvNewMsg,
        (int)CAPI_OnRecvReceipt,
        (int)CAPI_OnMsgRevoked,
        (int)CAPI_OnRecvOffline,
        (int)CAPI_OnMsgDeleted,
        (int)CAPI_OnRecvOnline
    );
...
int StoreConvListener(
    ...
    RegisterConvListener(
        (int)CAPI_OnConvSyncStart,
        (int)CAPI_OnConvSyncFinish,
        (int)CAPI_OnConvSyncProgress,
        (int)CAPI_OnConvSyncFailed,
        (int)CAPI_OnConvChanged,
        (int)CAPI_OnNewConv,
        (int)CAPI_OnUnreadChanged,
        (int)CAPI_OnInputStatus
    );
...
int StoreGroupListener(
    ...
    RegisterGroupListener(
        (int)CAPI_OnGroupJoinedAdd,
        (int)CAPI_OnGroupJoinedDel,
        (int)CAPI_OnGroupMemberAdd,
        (int)CAPI_OnGroupMemberDel,
        (int)CAPI_OnGroupAppAdd,
        (int)CAPI_OnGroupAppDel,
        (int)CAPI_OnGroupInfoChanged,
        (int)CAPI_OnGroupDismissed,
        (int)CAPI_OnGroupMemberInfo,
        (int)CAPI_OnGroupAppAccept,
        (int)CAPI_OnGroupAppReject
    );
...
int StoreFriendListener(
    ...
    RegisterFriendListener(
        (int)CAPI_OnFriendAppAdd,
        (int)CAPI_OnFriendAppDel,
        (int)CAPI_OnFriendAppAccept,
        (int)CAPI_OnFriendAppReject,
        (int)CAPI_OnFriendAdd,
        (int)CAPI_OnFriendDel,
        (int)CAPI_OnFriendInfo,
        (int)CAPI_OnBlackAdd,
        (int)CAPI_OnBlackDel
    );
...
int StoreUserListener(napi_env env, napi_value onSelfInfo, napi_value onUserStatus) {
    ...
    RegisterUserListener(
        (int)CAPI_OnUserSelfInfoUpdated,
        (int)CAPI_OnUserStatusChanged
    );
...
int StoreSignalingListener(
    ...
    RegisterSignalingListener(
        (int)CAPI_OnSignalingReceiveNewInvitation,
        (int)CAPI_OnSignalingInviteeAccepted,
        (int)CAPI_OnSignalingInviteeAcceptedByOtherDevice,
        (int)CAPI_OnSignalingInviteeRejected,
        (int)CAPI_OnSignalingInviteeRejectedByOtherDevice,
        (int)CAPI_OnSignalingInvitationCancelled,
        (int)CAPI_OnSignalingInvitationTimeout,
        (int)CAPI_OnSignalingHangUp,
        (int)CAPI_OnSignalingRoomParticipantConnected,
        (int)CAPI_OnSignalingRoomParticipantDisconnected
    );
...
int StoreCustomBusinessListener(napi_env env, napi_value onRecvCustomBusinessMessage) {
    ...
    RegisterCustomBusinessListener((int)CAPI_OnRecvCustomBusinessMessage);
...
int StoreMsgKvInfoListener(napi_env env, napi_value onMessageKvInfoChanged) {
    ...
    RegisterMsgKvInfoListener((int)CAPI_OnMessageKvInfoChanged);
...
void CAPI_OnFriendAdd(int cbId, const char* friend) {
    CallStringCallback(g_listeners.env, g_listeners.onFriendAdd, friend);
}

void CAPI_OnFriendDel(int cbId, const char* friend) {
    CallStringCallback(g_listeners.env, g_listeners.onFriendDel, friend);
}
